...
describe("3 - Verifica os multi-ambientes e modo de desenvolvimento", () => {
  it.skip("Será validado que a tag de desenvolvimento foi encontrada no frontend de desenvolvimento", () => {
    cy.visit(FRONT_URL);
    cy.contains("Em desenvolvimento").should("exist");
  });
  
  it.skip("Será validado que a tag de desenvolvimento não existe no frontend de produção", () => {
